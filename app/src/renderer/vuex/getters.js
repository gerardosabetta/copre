let getters = {
  ...
  nonObservers: (state, getters) => getters.paisesPresentes.filter(paises => paises.type == "country"),
  Observers: (state, getters) => getters.paisesPresentes.filter(paises => paises.type == "observer"),
